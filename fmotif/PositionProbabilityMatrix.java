...
public class PositionProbabilityMatrix {
    // JDBC driver name and database URL
    Vector pwmseq;
    boolean relativefrequencyflag = true;
    ...
    public PositionProbabilityMatrix(){

    }
    public PositionProbabilityMatrix(querydata data){
        Data = data;

   }
   public PositionProbabilityMatrix(querydata data,Vector seqin){
        Data = data;
        pwmseq = seqin;

   }
   public PositionProbabilityMatrix(querydata data,List seqin){
       Data = data;
   ...
   public static void main(String args[]) {
        ...
        PositionProbabilityMatrix wmatrix = new  PositionProbabilityMatrix();
       wmatrix.start('p');
    try {
   ...
   public  void SetRelativeFlag ()
   {
       relativefrequencyflag = true;
   }
   public  void SetAbsoluteFlag ()
   {
       relativefrequencyflag = false;
   }
